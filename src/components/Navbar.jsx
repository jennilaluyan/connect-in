                            ...
                            <> {/* Tampilkan navigasi berdasarkan role dari displayUser */}
                                ...
                                {displayUser.role === 'hr' && displayUser.is_hr_approved_by_sa && (
                                    <>
                                        ...
                                        <NavItem icon={<NotificationBell size={18} />} label="Notifikasi" to="/hr/notifikasi" isActive={activeNavItem === "Notifikasi HR"} activeColor={activeColor} hoverColor={hoverColor} onClick={closeAllMenus} />
                                ...
                                {displayUser.role === 'user' && (
                                    <>
                                        ...
                                        <NavItem icon={<NotificationBell size={18} />} label="Notifikasi" to="/notifikasi" isActive={activeNavItem === "Notifikasi"} activeColor={activeColor} hoverColor={hoverColor} onClick={closeAllMenus} />
                                    </>
                                )}
                    ...
                    <div className="px-2 pt-2 pb-3 space-y-1">
                        ...
                        {displayUser.role === 'hr' && displayUser.is_hr_approved_by_sa && (
                            <>
                                ...
                                <MobileNavItem icon={<NotificationBell size={20} />} label="Notifikasi" to="/hr/notifikasi" isActive={activeNavItem === "Notifikasi HR"} activeColor={activeColor} onClick={closeAllMenus} />
                        ...
                        {displayUser.role === 'user' && (
                            <>
                                ...
                                <MobileNavItem icon={<NotificationBell size={20} />} label="Notifikasi" to="/notifikasi" isActive={activeNavItem === "Notifikasi"} activeColor={activeColor} onClick={closeAllMenus} />
                            </>
                        )}
