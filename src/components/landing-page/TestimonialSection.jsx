...
const TestimonialsSection = () => {
  ...
  return (
    <section className="py-12 md:py-24 bg-[#D6E6FF] text-center px-16 md:px-12" id="testimonials">
      ...
      <p className="text-gray-600 mb-8 md:mb-12 max-w-2xl mx-auto">Mahasiswa dan alumni UNSRAT telah merasakan manfaat dari platform ini. Simak pengalaman mereka!</p>
