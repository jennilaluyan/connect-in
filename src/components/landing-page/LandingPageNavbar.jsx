// src/components/landing-page/Navbar.jsx
import React, { useState } from "react";
import { Link } from "react-router-dom"; // Hanya butuh Link, tidak perlu useNavigate di sini

const LandingPageNavbar = () => { // Ganti nama komponen menjadi LandingPageNavbar
    ...
    <nav className="transition-all duration-300 bg-transparent">
      <div className="navbar max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
        <div className="flex justify-between items-center h-16">
          {/* Logo */}
          <Link to="/" className="logo w-auto max-w-fit md:text-2xl lg:text-3xl font-bold text-gray-900 title-900px transition-all duration-300 hover:scale-105">
            Connect IN
          </Link>
