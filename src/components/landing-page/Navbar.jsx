...
const Navbar = () => {
  ...
  return (
    <nav className="transition-all duration-300 bg-transparent">
      <div className="navbar max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex md:space-x-4 md:text-lg lg:space-x-8 text-base lg:text-xl space-x-8 font-medium nav-900px">
            <a href="/" className="text-gray-900 hover:text-gray-600 transition-all duration-300 hover:-translate-y-1 relative after:absolute after:bottom-0 after:left-0 after:w-0 after:h-0.5 after:bg-[#BCFC4D] after:transition-all after:duration-300 hover:after:w-full">
              Beranda
            </a>
            <a href="#feature-section" className="text-gray-900 hover:text-gray-600 transition-all duration-300 hover:-translate-y-1 relative after:absolute after:bottom-0 after:left-0 after:w-0 after:h-0.5 after:bg-[#BCFC4D] after:transition-all after:duration-300 hover:after:w-full">
              Fitur
            </a>
            <a href="#testimonials" className="text-gray-900 hover:text-gray-600 transition-all duration-300 hover:-translate-y-1 relative after:absolute after:bottom-0 after:left-0 after:w-0 after:h-0.5 after:bg-[#BCFC4D] after:transition-all after:duration-300 hover:after:w-full">
              Testimoni
            </a>
          </div>
      ...
      >
        <a href="/" className="block px-6 py-3 text-gray-900 hover:bg-gray-100 transition-all duration-300 hover:pl-8">
          Beranda
        </a>
        <a href="#features" className="block px-6 py-3 text-gray-900 hover:bg-gray-100 transition-all duration-300 hover:pl-8">
          Fitur
        </a>
        <a href="#testimonials" className="block px-6 py-3 text-gray-900 hover:bg-gray-100 transition-all duration-300 hover:pl-8">
          Testimoni
        </a>
